...
public class _2_Articulation_Point {
    ...
    // O(V+E)
    public static void tarjansAlgo_find_Articulation_Points(ArrayList<Edge> graph[]) {
        int n = graph.length;
    ...
    public static void main(String[] args) {
        ...
        graph3[0].add(new Edge(0, 1, 0));
        graph3[0].add(new Edge(0, 2, 0));
        graph3[0].add(new Edge(0, 3, 0));

        graph3[1].add(new Edge(1, 0, 0));
        graph3[1].add(new Edge(1, 2, 0));

        graph3[2].add(new Edge(2, 0, 0));
        graph3[2].add(new Edge(2, 1, 0));

        graph3[3].add(new Edge(3, 0, 0));
        graph3[3].add(new Edge(3, 4, 0));

        graph3[4].add(new Edge(4, 0, 0));
        graph3[4].add(new Edge(4, 3, 0));

        tarjansAlgo_find_Articulation_Points(graph1);
        System.out.println();
        tarjansAlgo_find_Articulation_Points(graph2);
        System.out.println();
        tarjansAlgo_find_Articulation_Points(graph3);
    }
}
