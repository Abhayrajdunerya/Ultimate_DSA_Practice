...
public class _5_Buy_Sell_Stock_5 {
    ...
    public static long maxProfit_recursion(long prices[], int n, int day, int canBuy) {
        ...
        if (canBuy == 1) {
            ...
            long sell = prices[day-1] + maxProfit_recursion(prices, n, day+2, 1);
    ...
    public static long maxProfit_memoization_util(long prices[], int n, int day, int canBuy, long dp[][]) {
        ...
        if (canBuy == 1) {
            ...
            long sell = prices[day-1] + maxProfit_memoization_util(prices, n, day+2, 1, dp);
        ...
        for (int day = n-1; day >= 0; day--) {
            for (int canBuy = 0; canBuy <= 1; canBuy++) {
                if (canBuy == 1) {
                    ...
                    long sell = prices[day] + dp[day+2][1];
